...
Type
  EAESError = Class(Exception);
    ...
    Procedure EncryptAES(Const InBuf: TAESBuffer;
      Const Key: TAESExpandedKey128; Var OutBuf: TAESBuffer); Overload;
    Procedure EncryptAES(Const InBuf: TAESBuffer;
      Const Key: TAESExpandedKey192; Var OutBuf: TAESBuffer); Overload;
    Procedure EncryptAES(Const InBuf: TAESBuffer;
      Const Key: TAESExpandedKey256; Var OutBuf: TAESBuffer); Overload;
    ...
    Procedure DecryptAES(Const InBuf: TAESBuffer;
      Const Key: TAESExpandedKey128; Var OutBuf: TAESBuffer); Overload;
    Procedure DecryptAES(Const InBuf: TAESBuffer;
      Const Key: TAESExpandedKey192; Var OutBuf: TAESBuffer); Overload;
    Procedure DecryptAES(Const InBuf: TAESBuffer;
