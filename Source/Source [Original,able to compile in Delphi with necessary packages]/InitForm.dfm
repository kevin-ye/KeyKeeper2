object Form2: TForm2
  ...
  Top = 0
  BorderIcons = []
  Caption = 'KeyKeeper V2.0    Initializing ... ...'
  ClientHeight = 199
  ClientWidth = 633
  Color = clBtnFace
  ...
  object spSkinShadowLabel1: TspSkinShadowLabel
    ...
    ShadowOffset = 0
    ShadowColor = clBlack
    Caption = 'Welcome! KeyKeeper V2.0    Powered By '#21494#22025#24433'Ye JiaYing'
    Align = alBottom
    ExplicitWidth = 305
  end
  ...
  object spSkinPasswordEdit1: TspSkinPasswordEdit
    Left = 113
    Top = 40
    Width = 472
    Height = 21
    ...
    OnKeyUp = spSkinPasswordEdit1KeyUp
  end
