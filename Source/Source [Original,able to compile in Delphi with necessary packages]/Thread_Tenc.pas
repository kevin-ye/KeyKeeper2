Unit Thread_Tenc;                //encrypting thread
...
Procedure Tenc.Execute;
Begin
  { Place thread code here }
  Form1.spSkinTabSheet3.Enabled := False;
  EncryptFile(trim(Form1.spSkinEdit1.Text), Form1.spSkinEdit1.Text + '.enc',
